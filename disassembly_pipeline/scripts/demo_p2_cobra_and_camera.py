...
from disassembly_pipeline.demos_for_guests import demo_kamera_cobra
...
if __name__ == "__main__":
    ...
    try:
        #demo_kamera_cobra(cy=cy, robot=p2, direction = 'back')
        demo_kamera_cobra(cy=cy, robot =p2, direction = 'front')
